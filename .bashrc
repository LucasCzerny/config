...
export PATH="$PATH:~/.local/helix"
export PATH="$PATH:~/.local/odin"
export PATH="$PATH:~/.local/ols"
export PATH="$PATH:~/.local/lua-language-server/bin"
export PATH="$PATH:/usr/local/go/bin"
export PATH="$PATH:/usr/local/lib/node_modules/vscode-langservers-extracted/bin"
source ~/.local/vulkan/setup-env.sh
